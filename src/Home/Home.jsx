          ...
          {!signOut
            ...
            <div className="navbar-right">
              <div className="navbar-right-button-holder">
                <button type="button" className="navbar-right-button" onClick={(e) => handleOnClick(e)}>Sign Out</button>
              </div>
              <div className="navbar-right-button-holder">
                <Link to="/admin">
                  <button type="button" className="navbar-right-button">Admin</button>
                </Link>
              </div>
            </div>
            )}
