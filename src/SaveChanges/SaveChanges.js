...
function SaveChanges(props) {
    ...
    return (
        <div>
            <button className="save-changes-button" onClick={(e) => handleOnClick(e)} disabled={!props.saveState}>
                Save Changes
            </button>
        </div>
    )
...
const mapStatetoProps = (state) => {
    return {...state.newLinkReducer, ...state.userDetailsReducer, ...state.saveChangeReducer}
}
